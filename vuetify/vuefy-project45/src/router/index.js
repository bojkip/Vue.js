...
import AllLightCategories from '@/components/Categories/Light/AllLightCategories.vue';
import Luminance from '@/components/Categories/Light/Luminance.vue';
...
const routes = [
  ...
  {
    path: '/all-light-categories',
    name: 'all-light-categories',
    component: AllLightCategories,
  },
  {
    path: '/luminance',
    name: 'luminance',
