...
<v-card class="px-5" flat >
    ...
    >
        <v-col lg="4" sm="4">
        <v-text-field outlined label="Your Number" hint="Number Only" placeholder="120" v-model="inputNum" :value="convertTime" type="number"></v-text-field>
        </v-col>
        <v-col
        lg="4" sm="4"
        >
    ...
    <v-row justify="center">
        <v-col lg="4" sm="4" class="d-none d-sm-flex d-md-flex d-lg-flex" >
